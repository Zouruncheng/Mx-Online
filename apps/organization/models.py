...
class CourseOrg(models.Model):
    ...
    category = models.CharField(default="pxjg", max_length=20, choices=(("pxjg", "培训机构"),
                                                                        ("gr", "个人"),
                                                                        ("gx", "高校")), verbose_name=u"机构类别")
    ...
    add_time = models.DateTimeField(default=datetime.now)
    tag = models.CharField(default="全国知名", verbose_name=u"机构标签", max_length=10)
